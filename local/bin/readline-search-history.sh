...
READLINE_SEARCH_HISTORY_INPUT_FILEPATH=${READLINE_SEARCH_HISTORY_INPUT_FILEPATH:-${GDBHISTFILE:-~/.gdb_history}}
...
cat "$READLINE_SEARCH_HISTORY_INPUT_FILEPATH" | perl -e 'print reverse<>' | awk '!a[$0]++' | colorlize \
